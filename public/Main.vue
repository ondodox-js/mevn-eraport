                        ...
                        <table class="posts-table">
                            <thead>
                                <tr class="users-table-info">
                                    <th>
                                        <label
                                            class="users-table__checkbox ms-20"
                                        >
                                            <input
                                                type="checkbox"
                                                class="check-all"
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="pages-table-img">
                                            <picture
                                                ><source
                                                    srcset="
                                                        /img/avatar/avatar-face-04.webp
                                                    "
                                                    type="image/webp" />
                                                <img
                                    ...
                                    <td>
                                        <div class="pages-table-img">
                                            <picture
                                                ><source
                                                    srcset="
                                                        /img/avatar/avatar-face-03.webp
                                                    "
                                                    type="image/webp" />
                                                <img
                                    ...
                                    <td>
                                        <div class="pages-table-img">
                                            <picture
                                                ><source
                                                    srcset="
                                                        /img/avatar/avatar-face-02.webp
                                                    "
                                                    type="image/webp" />
                                                <img
                                    ...
                                    <td>
                                        <div class="pages-table-img">
                                            <picture
                                                ><source
                                                    srcset="
                                                        /img/avatar/avatar-face-05.webp
                                                    "
                                                    type="image/webp" />
                                                <img
                                ...
                                <tr>
                                    ...
                                    <td>
                                        How to build a loyal community online
                                        and offline
                                    </td>
                                    <td>
                                        <div class="pages-table-img">
